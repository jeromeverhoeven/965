...
|Instructions|
|----|
|A requirements are put into four different categories **Mu**st, **S**hould, **Co**uld, **W**ont: each line should be a user story, constraint, criteria, feature, parameter, or something else that describes and defines the project. If it is important to the project write it down, if you don't how is the next guy supposed to know to consider it.|
...
|6| Kitchen | Kitchen shall be a space where there is room to have a stove, sink, refrigerator, and counter space sufficient to prepare meals | **Must** | We are not changing the kitchen, just moving it, so we are not adding any new kitchen space, but we are not losing any either |
|7| Garage | Garage shall be a space where there is room to park 2 cars and have some storage space | **Must** | |
|8| Bathroom x 3 | Maintian 3 bathrooms, one of which is a master bathroom with a shower, the other two can be full or half baths | **Must** | |
